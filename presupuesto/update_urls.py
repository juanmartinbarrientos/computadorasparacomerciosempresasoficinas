...
def replace_urls(filepath):
    ...
    # Replacements
    content = content.replace('https://raw.githubusercontent.com/juanmartinbarrientos/Mis-Redes/main/LandingPage/pc_a_medida.jpg', 'https://juanmartinbarrientos.github.io/computadorasparacomerciosempresasoficinas/presupuesto/pc_a_medida.jpg')
    content = content.replace('https://juanmartinbarrientos.github.io/LandingPage/', 'https://juanmartinbarrientos.github.io/computadorasparacomerciosempresasoficinas/presupuesto/')
...
def replace_css(filepath):
    ...
    content = content.replace("url('https://juanmartinbarrientos.github.io/computadorasparacomerciosempresasoficinas/presupuesto/pc_a_medida.jpg')", "url('pc_a_medida.jpg')")
